...
function M.retrieve(is_math)
  ...
  return {
    ...
    parse_snippet({ trig = "grad", name = "gradient" }, "\\nabla"),
    ...
    parse_snippet({ trig = "eps", name = "R" }, "\\epsilon"),
    parse_snippet({ trig = "CC", name = "C" }, "\\mathcal{C}"),
    ...
    parse_snippet({ trig = "ee", name = "in" }, "\\in "),
    ...
    parse_snippet({ trig = "cal", name = "cal" }, "\\mathcal{$1}"),
    parse_snippet(
